...
/**
 * Interface para el resultado al cerrar el modal
 */
export interface CalendarModalResult {
  selectedDate: Date;
}
...
export class CalendarModalComponent implements OnInit {
  ...
  selectDay(day: CalendarDay) {
    ...
    // Cerrar modal y retornar fecha seleccionada
    this.dismiss(day.date);
  }
  ...
  dismiss(selectedDate?: Date) {
    if (selectedDate) {
      const result: CalendarModalResult = {
